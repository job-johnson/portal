...
function RemoveHTMLTags(html) {
  ...
  jQuery.ajax({
    type: 'GET',
      ...
      var json = jQuery.parseJSON(e);
            ...
            var length = 300; // char length for the string.
  ...
  jQuery.ajax({
    type: 'GET',
        url: 'https://t5i5zt0tra.execute-api.us-east-1.amazonaws.com/prod/homepage?path=environment&limit=8',
        success: function(e){
      ...
      var json = jQuery.parseJSON(e);
            ...
            var end= ""; // string to place at the end when a large content is formatted
            var length = 300; // char length for the string.
            var desc_length = 300; // char length for the string.
            var slider_item_count = 4-1;
            jQuery.each(json,function(i, item){
              // var shortDesc = RemoveHTMLTags(this.short_description);
              var shortDesc = this.short_description;
  ...
  jQuery.ajax({
    type: 'GET',
        ...
        success: function(e){
            ...
            var end= ""; // string to place at the end when a large content is formatted
            var desc_length = 300; // char length for the string.
            var title_length = 300; // char length for the string.
            var mob_title_length = 55; // char length for the string.
  ...
  jQuery.ajax({
    type: 'GET',
      ...
      var json = jQuery.parseJSON(e);
            ...
            var length = 300; // char length for the string.
            var title_length = 300; // char length for the string.
            var mob_title_length = 300; // char length for the string.
            var slider_item_count = 2-1;
            jQuery.each(json,function(i, item){
              var shortDesc = RemoveHTMLTags(this.short_description);
              shortDesc = String(shortDesc).substring(0, length) + end;
              var image = this.image;
              var title = String(this.short_title).substring(0, 300) + end;
              var mob_title = String(this.short_title).substring(0, mob_title_length) + end;
              var slug = this.slug
