...
<span class="ad_close"></span>
   ...
   <div id="two-column" class="clearfix">
    <div class="new-title">
      <span class="title_inner clearfix">
                    <span class="title_text">Ziwira<i class="icon-right-arrow"></i>Food</span>
                </span>
                <span class="clearfix">
                  <span class="title_text"><span class="icon_comm"><i class="icon-food"></i></span>Food</span>
                </span>
    </div>
  ...
  <div id="two-column" class="clearfix">
    <div id="left-block" class="pull-left bg-color top-left">
            ...
            <?php echo do_shortcode('[wpv-view name="food-landing-first"]'); ?>
...
?>
  ...
  <div id="two-column" class="clearfix">
    <?php echo do_shortcode('[wpv-view name="food-landing-all"]'); ?>
  </div>
